...
var textMap = {
    ...
    HEATING_CLIMATECONTROL_TRANSCEIVER__ACTIVE_PROFILE: "** TRANSCEIVER__ACTIVE_PROFILE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__ACTUAL_TEMPERATURE: "** TRANSCEIVER__ACTUAL_TEMPERATURE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__BOOST_MODE: "** TRANSCEIVER__BOOST_MODE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__CONTROL_DIFFERENTIAL_TEMPERATURE: "** TRANSCEIVER__CONTROL_DIFFERENTIAL_TEMPERATURE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__CONTROL_MODE: "** TRANSCEIVER__CONTROL_MODE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__DURATION_UNIT: "** TRANSCEIVER__DURATION_UNIT",
    HEATING_CLIMATECONTROL_TRANSCEIVER__DURATION_VALUE: "** TRANSCEIVER__DURATION_VALUE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__FROST_PROTECTION__FALSE: "** TRANSCEIVER__FROST_PROTECTION__FALSE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__FROST_PROTECTION: "** TRANSCEIVER__FROST_PROTECTION",
    HEATING_CLIMATECONTROL_TRANSCEIVER__FROST_PROTECTION__TRUE: "** TRANSCEIVER__FROST_PROTECTION__TRUE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__HUMIDITY: "** TRANSCEIVER__HUMIDITY",
    HEATING_CLIMATECONTROL_TRANSCEIVER__LEVEL:  "** TRANSCEIVER__LEVEL",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_MODE__FALSE: "** TRANSCEIVER__PARTY_MODE__FALSE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_MODE__TRUE: "** TRANSCEIVER__PARTY_MODE__TRUE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_MODE: "** TRANSCEIVER__PARTY_MODE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_SET_POINT_TEMPERATURE: "** TRANSCEIVER__PARTY_SET_POINT_TEMPERATURE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_TIME_END: "** TRANSCEIVER__PARTY_TIME_END",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_TIME_START: "** TRANSCEIVER__PARTY_TIME_START",
    HEATING_CLIMATECONTROL_TRANSCEIVER__SWITCH_POINT_OCCURED__FALSE: "** TRANSCEIVER__SWITCH_POINT_OCCURED__FALSE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__SWITCH_POINT_OCCURED: "** TRANSCEIVER__SWITCH_POINT_OCCURED",
    HEATING_CLIMATECONTROL_TRANSCEIVER__SWITCH_POINT_OCCURED__TRUE: "** TRANSCEIVER__SWITCH_POINT_OCCURED__TRUE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_ADAPTION: "** TRANSCEIVER__VALVE_ADAPTION",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__0: "** TRANSCEIVER__VALVE_STATE__0",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__1: "** TRANSCEIVER__VALVE_STATE__1",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__2: "** TRANSCEIVER__VALVE_STATE__2",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__3: "** TRANSCEIVER__VALVE_STATE__3",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__4: "** TRANSCEIVER__VALVE_STATE__4",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__5: "** TRANSCEIVER__VALVE_STATE__5",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__6: "** TRANSCEIVER__VALVE_STATE__6",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__7: "** TRANSCEIVER__VALVE_STATE__7",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__8: "** TRANSCEIVER__VALVE_STATE__8",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE: "** TRANSCEIVER__VALVE_STATE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__WINDOW_STATE__FALSE: "** TRANSCEIVER__WINDOW_STATE__FALSE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__WINDOW_STATE: "** TRANSCEIVER__WINDOW_STATE",
    HEATING_CLIMATECONTROL_TRANSCEIVER__WINDOW_STATE__TRUE: "** TRANSCEIVER__WINDOW_STATE__TRUE",
    ...
    SHUTTER_CONTACT__STATE__0: "cerrado",
    ...
    SWITCH_VIRTUAL_RECEIVER__STATE__TRUE:"en",
    SWITCH_VIRTUAL_RECEIVER__STATE__FALSE:"apagado",
    SWITCH_VIRTUAL_RECEIVER__PROCESS:"-",
    SWITCH_VIRTUAL_RECEIVER__SECTION:"-",
    SWITCH_VIRTUAL_RECEIVER__SECTION_STATUS:"-",
    SWITCH_VIRTUAL_RECEIVER__ON_TIME:"deber",
    SWITCH_TRANSMITTER__STATE__TRUE:"en",
    SWITCH_TRANSMITTER__STATE__FALSE:"apagado",
    ...
    THERMALCONTROL_TRANSMIT__BATTERY_STATE: "voltaje de la batería",
    ...
    CLIENT_CODE: "El cliente no fue reconocido. Introduce el código de cliente: (Tareas desconocidas considere Registro de cliente)",
    CLIENT_CODE_COMFIRM_1: "El código de cliente es",
    CLIENT_CODE_COMFIRM_2: "Haga clic en Aceptar cuando la información es correcta.",
    CLIENT_RECOGNITION: "el reconocimiento del cliente",
    CLIENT_AUTO: "De forma automática a través de IP",
    CLIENT_MANU: "Manual por la demanda",
    BG_PIC: "Gráfico fondo",
    ROOMS_PIC: "Gráfico por habitaciones",
