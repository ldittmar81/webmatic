...
var textMap = {
    ...
    GLOBAL_SETTINGS_HIDE_WARNING: "Внимание! Если скрыть параметры для всех устройств, он должен быть явно видно, по крайней мере для устройства. При необходимости вы должны быть переданы непосредственно к настройке КСУ."
};
