...
var textMap = {
    ...
    SENSOR__SENSOR__TRUE: "открыть",
    SENSOR__SENSOR__FALSE: "закрытая",
    ...
    SWITCH_VIRTUAL_RECEIVER__STATE__TRUE: "на",
    SWITCH_VIRTUAL_RECEIVER__STATE__FALSE: "от",
    ...
    THERMALCONTROL_TRANSMIT__BATTERY_STATE: "напряжение батареи",
    ...
    CLIENT_CODE: "Клиент не был признан. Введите код клиента: (Неизвестные задачи считаются реестра клиента)",
    CLIENT_CODE_COMFIRM_1: "Клиентский код",
    CLIENT_CODE_COMFIRM_2: "Нажмите кнопку OK, если информация верна.",
