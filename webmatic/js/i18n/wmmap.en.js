...
var textMap = {
    ...
    DIGITAL_INPUT__STATE__TRUE: "yes",
    ...
    SENSOR__SENSOR__TRUE: "open",
    SENSOR__SENSOR__FALSE: "closed",
    ...
    DEFAULT_READONLY: "Variable standard read-only",
    ...
    END_CLIENT_MODUS: "End Client Setup Mode",
    REMOVE_MESSAGES: "Remove Outdated disorders",
    ABOUT: "about",
    SERVICE_NOTE: "Service notifications",
    NO_DISORDERS: "No service messages available",
    TWO_SITES_VERSION: "Display on 2 pages",
    TWO_SITES_TRANSITION: "Effect at the change of page",
    BACK: "Back",
    NUMBER_OF_COLUMNS: "Number of columns",
    STEP: "Step",
    FACTOR: "Factor",
    SHOW_DESCRIPTION: "Show description",
    SHOW_LAST_TIME_USED: "Show last time used",
    WORKSPACE: "Workspace",
    ...
    CLIENT_CODE: "Client was not recognized. Enter client code: (Unknown tasks deemed Client Registry)",
    CLIENT_CODE_COMFIRM_1: "Client code is",
    CLIENT_CODE_COMFIRM_2: "Click OK when the information is correct.",
