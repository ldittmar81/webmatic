...
var textMap = {
    ...
    AKKU__STATUS__1: "Akku l&auml;dt",
    ...
    HEATING_CLIMATECONTROL_TRANSCEIVER__ACTIVE_PROFILE: "Aktives Wochenprogramm",
    HEATING_CLIMATECONTROL_TRANSCEIVER__ACTUAL_TEMPERATURE: "Aktuelle Temperatur",
    HEATING_CLIMATECONTROL_TRANSCEIVER__BOOST_MODE: "Boost",
    HEATING_CLIMATECONTROL_TRANSCEIVER__CONTROL_DIFFERENTIAL_TEMPERATURE: "Control Differenz Temperatur",
    HEATING_CLIMATECONTROL_TRANSCEIVER__CONTROL_MODE: "Modus Auto/Manuell",
    HEATING_CLIMATECONTROL_TRANSCEIVER__DURATION_UNIT: "Dauer Einheit",
    HEATING_CLIMATECONTROL_TRANSCEIVER__DURATION_VALUE: "Dauer Wert",
    HEATING_CLIMATECONTROL_TRANSCEIVER__FROST_PROTECTION__FALSE: "Frostschutz aus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__FROST_PROTECTION: "Frostschutz",
    HEATING_CLIMATECONTROL_TRANSCEIVER__FROST_PROTECTION__TRUE: "Frostschutz an",
    HEATING_CLIMATECONTROL_TRANSCEIVER__HUMIDITY: "Luftfeuchtigkeit",
    HEATING_CLIMATECONTROL_TRANSCEIVER__LEVEL:  "Ventilöffnung",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_MODE__FALSE: "Urlaubsmodus aus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_MODE__TRUE: "Urlaubsmodus an",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_MODE: "Urlaubsmodus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_SET_POINT_TEMPERATURE: "Temperatur Urlaubsmodus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_TIME_END: "Endzeit Urlaubsmodus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__PARTY_TIME_START: "Anfangszeit Urlaubsmodus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__SWITCH_POINT_OCCURED__FALSE: "Solltemperatur nicht geändert",
    HEATING_CLIMATECONTROL_TRANSCEIVER__SWITCH_POINT_OCCURED: "Solltemperatur angepasst",
    HEATING_CLIMATECONTROL_TRANSCEIVER__SWITCH_POINT_OCCURED__TRUE: "Solltemperatur geändert",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_ADAPTION: "Adaptionsfahrt",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__0: "Ventilstatus unbekannt",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__1: "Ventil fährt in Ausgangsposition",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__2: "Warte auf Adaptionsfahrt",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__3: "Adaptionsfahrt aktiv",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__4: "Adaptionsfahrt durchgeführt",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__5: "Ventil klemmt",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__6: "Ventilstellbereich zu gross",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__7: "Ventilstellbereich zu klein",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE__8: "Ventil in Fehlerposition",
    HEATING_CLIMATECONTROL_TRANSCEIVER__VALVE_STATE: "Status Ventilantrieb",
    HEATING_CLIMATECONTROL_TRANSCEIVER__WINDOW_STATE__FALSE: "Fenster geschlossen",
    HEATING_CLIMATECONTROL_TRANSCEIVER__WINDOW_STATE: "Fensterstatus",
    HEATING_CLIMATECONTROL_TRANSCEIVER__WINDOW_STATE__TRUE: "Fenster offen",
    ...
    SENSOR__SENSOR__TRUE: "offen",
    SENSOR__SENSOR__FALSE: "geschlossen",
    ...
    SYSTEM__OPTION_1: "Daten f&uuml;r vordefiniertes Template 1",
    SYSTEM__OPTION_2: "Daten f&uuml;r vordefiniertes Template 2",
    SYSTEM__OPTION_3: "Daten f&uuml;r vordefiniertes Template 3",
    SYSTEM__OPTION_4: "Daten f&uuml;r vordefiniertes Template 4",
    SYSTEM__OPTION_5: "Daten f&uuml;r vordefiniertes Template 5",
    ...
    SWITCH__IP: "Adresse nach DNS-Aufl&ouml;sung",
    SWITCH__UNREACH_CTR: "Fehlversuche",
    SWITCH_VIRTUAL_RECEIVER__STATE__TRUE:"an",
    SWITCH_VIRTUAL_RECEIVER__STATE__FALSE:"aus",
    SWITCH_VIRTUAL_RECEIVER__PROCESS:"-",
    SWITCH_VIRTUAL_RECEIVER__SECTION:"-",
    SWITCH_VIRTUAL_RECEIVER__SECTION_STATUS:"-",
    SWITCH_VIRTUAL_RECEIVER__ON_TIME:"Einschaltdauer",
    SWITCH_TRANSMITTER__STATE__TRUE:"an",
    SWITCH_TRANSMITTER__STATE__FALSE:"aus",
    ...
    THERMALCONTROL_TRANSMIT__BATTERY_STATE: "Batteriespannung",
    ...
    SYSVARALARMZONE1TRIGGERED: "ausgel&ouml;st",
    SYSVARALARMZONE1NOTTRIGGERED: "nicht ausgel&ouml;st",
    ...
    EDIT: "Bearbeiten",
    OPTIONS: "Optionen",
    OPTIONS_CLIENT: "Optionen f&uuml;r dieses Ger&auml;t",
    ...
    SMALL: "Klein",
    BIG: "Groß",
    GRAPHICS_SIZE: "Gr&ouml;ße der Men&uuml;grafiken",
    FILTER: "Daten filtern...",
    TRANSFER: "&Uuml;bertrage...",
    DELAY: "Wert wird noch an Ger&auml;t &uuml;bertragen und erst verz&ouml;gert hier dargestellt.",
    TRANSFER_OK: "OK!",
    IMAGE_UPLOAD: "Es k&ouml;nnen nur JPG, GIF oder PNG hochgeladen werden!",
    START: "Starte...",
    NEW_VERSION: "Neue WebMatic Version",
    DOWNLOAD: "runterladen",
    MANUAL: "nur manuelle Ausf&uuml;hrung",
    OPERATABLE: "bedienbar",
    HISTORIAN_DURATION: "Die letzen...",
    CHOOSE_THEME: "Motiv ausw&auml;hlen",
    NOT_SELECTED: "globale Einstellung",
    DESIGN: "Aussehen",
    FONT: "Schriftart",
    MENU: "Men&uuml;eintr&auml;ge",
    ...
    NEW_UPDATES_WARNING: "Informationen &uuml;ber neue Versionen",
    STABLE: "nur stabile Versionen",
    ALPHA: "auch &uuml;ber alpha Versionen",
    OTHERS: "Sonstiges",
    DONT_LEAVE: "Versehentliches Verlassen der Seite verhindern",
    CHOOSE: "Bitte w&auml;hlen",
    DELETE_SETTINGS: "Einstellungen l&ouml;schen",
    RELOAD: "Reload",
    CLIENT_SETTINGS: "Einstellungen der Clients",
    CLIENT_TITLE: "Name des Clients",
    DEFAULT_SORT: "Standardsortierung",
    ALPHABETICAL: "Alphabetisch",
    MANUALLY: "H&auml;ndisch",
    DELETE_SETTINGS_WARNING: "Achtung! Alle Einstellungen des ausgew&auml;hlten Clients werden gel&ouml;scht.",
    END_CLIENT_MODUS: "Client Einstellung Modus beenden",
    REMOVE_MESSAGES: "Veraltete St&ouml;rungen entfernen",
    ABOUT: "&uuml;ber",
    ...
    ONLY_PIC: "Nur Grafik",
    DIVIDE: "Aufteilung",
    ADD_DIVIDER: "Teiler hinzuf&uuml;gen",
    UNSORTED: "unsortiert",
    SAVE_AND_RELOAD: "Speichern und neu laden",
    RELOAD_CCU_CHANGES: "&Auml;nderung festgestellt",
    CLIENT_CODE: "Client wurde nicht erkannt. Bitte Client-Code eingeben: (Unbekannten Eingaben gelten als Client-Registrierung)",
    CLIENT_CODE_COMFIRM_1: "Client-Code ist",
    CLIENT_CODE_COMFIRM_2: "Klicken Sie auf OK, wenn die Angabe richtig ist.",
    CLIENT_RECOGNITION: "Clienterkennung",
    ...
    VARIABLES_PIC: "Grafik f&uuml;r Systemvariablen"
};
