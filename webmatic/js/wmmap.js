...
var textMap = {
    ...
    ALARMACTUATOR__ERROR_POWER: "ERROR_POWER",
    ALARMACTUATOR__ERROR_SABOTAGE: "ERROR_SABOTAGE",
    ...
    BLIND__STOP: "Stop",
    BLIND__INHIBIT: "-",
    BLIND__WORKING: "BLIND__WORKING",
    BLIND__DIRECTION: "BLIND__DIRECTION",
    ...
    CLIMATECONTROL_REGULATOR__SETPOINT: "CLIMATECONTROL_REGULATOR__SETPOINT",
    CLIMATECONTROL_REGULATOR__ADJUSTING_COMMAND: "ADJUSTING_COMMAND",
    CLIMATECONTROL_REGULATOR__ADJUSTING_DATA: "ADJUSTING_DATA",
    CLIMATECONTROL_REGULATOR__STATE: "STATE",
    ...
    CLIMATECONTROL_RT_TRANSCEIVER__FAULT_REPORTING: "FAULT_REPORTING",
    ...
    CLIMATECONTROL_RT_TRANSCEIVER__CONTROL_MODE: "CONTROL_MODE",
    CLIMATECONTROL_RT_TRANSCEIVER__BOOST_STATE: "BOOST_STATE",
    CLIMATECONTROL_RT_TRANSCEIVER__BATTERY_STATE: "BATTERY_STATE",
    CLIMATECONTROL_RT_TRANSCEIVER__SET_TEMPERATURE: "SET_TEMPERATURE",
    ...
    CLIMATECONTROL_VENT_DRIVE__ERROR: "CLIMATECONTROL_VENT_DRIVE__ERROR",
    ...
    DIMMER__ERROR: "ERROR",
    DIMMER__ERROR_REDUCED: "ERROR_REDUCED",
    DIMMER__ERROR_OVERHEAT: "ERROR_OVERHEAT",
    DIMMER__ERROR_OVERLOAD: "ERROR_OVERLOAD",
    ...
    RGBW_AUTOMATIC__PROGRAM: "PROGRAM",
    ...
    ROTARY_HANDLE_SENSOR__STATE: "STATE",
    ROTARY_HANDLE_SENSOR__ERROR: "ERROR",
    ROTARY_HANDLE_SENSOR__LOWBAT: "LOWBAT",
    SENSOR__COUNTER: "-",
    SENSOR__SUM: "-",
    ...
    SHUTTER_CONTACT__STATE: "STATE",
    SHUTTER_CONTACT__ERROR: "ERROR",
    SHUTTER_CONTACT__LOWBAT: "LOWBAT",
    ...
    THERMALCONTROL_TRANSMIT__LOWBAT_REPORTING: "Batteriewechsel",
    ...
    VIRTUAL_DIMMER__ERROR_REDUCED: "ERROR_REDUCED",
    VIRTUAL_DIMMER__ERROR_OVERHEAT: "ERROR_OVERHEAT",
    VIRTUAL_DIMMER__ERROR_OVERLOAD: "ERROR_OVERLOAD",
...
function mapState(hssType, deviceHssType, valFloat, valBool) {
    ...
    if (type) {
        switch (type) {
            ...
            case 4:
                return valBool?"ON":"OFF";
            case 5:
                return valBool?"Error":"NoError";
            case 6:
                return valBool?"Warning":"NoError";
            case 7:
                if (valFloat === 0.0) { return "0"; }
                else if (valFloat === 1.0) { return "1"; }
                else if (valFloat === 2.0) { return "2"; }
                else return "Warning";
        }        
    }
...
function mapInput(hssType, deviceHssType, channelId, valString, vorDate){
    ...
    if(input){
        switch (input) {
            case "BoolButtonList":
                return addSetBoolButtonList(channelId, valString, mapText(deviceHssType + "__" + hssType + "__OFF"), mapText(deviceHssType + "__" + hssType + "__ON"), "", vorDate, true);
            case "Button":
