// ‹bersetzungen von HomeMatic IDs zu sprechenden Texten f√ºr alle
...
var textMap = {
    ...
    CLIMATECONTROL_RT_TRANSCEIVER__FAULT_REPORTING__1: "Ventilantrieb schwerg√§ngig",
    ...
    DIGITAL_OUTPUT__STATE: "** DIGITAL_OUTPUT__STATE",
    DIMMER__PROG_TIMER: "-",
    ...
    SWITCH__IP: "Adresse nach DNS-Auflˆsung",
...
function mapText(text, defaultText) {
    ...
    // Wenn nichts gefunden, dann Originaltext zur√ºck:
    if (!newText) {
        return text;
    } else {
        return newText;
...
function mapImage(text) {
    ...
    // Wenn keines gefunden, dann unknown.png zur√ºck:
    if (!gfx) {
        return "unknown.png";
    } else {
        return gfx;
